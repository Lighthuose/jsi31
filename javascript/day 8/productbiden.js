document.getElementById("submitComment").onclick = function name(params) {
  ...
  let hourinput = document.getElementById("hourinput1");
  
  let dateinput = document.getElementById("dateinput1");
  ...
  button.addEventListener("click",function(){
    ...
    if (hourinput.value === "" || dateinput.value === "") {
        ...
        localStorage.setItem("objectdate",JSON.stringify(objectdate));
    }
